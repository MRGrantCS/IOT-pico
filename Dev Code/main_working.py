...
# Setup onboard LED for heartbeat
onboard = machine.Pin("LED", machine.Pin.OUT)

# Setup all external LEDs
red = LED(16)
yellow = LED(17)
green = LED(18)
white = LED(19)
...
# Define music as strings 
# To create you own go to - https://onlinesequencer.net/ - find and open edit/create a music sequence - STRG+A and STRG+C to copy all music notes - paste them here, assign to variable, remove ending ;: and starting "Online Sequencer:NUMBER:"
...
# Default starting song is set to song1
mySong = music(song1, pins=[Pin(15)])

# Setup flags for turning on and off LED display and music
display = False
buzz = False
